            ...
            modelBuilder.Entity("ProfitAndLoss.Data.Models.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actived = true,
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 640, DateTimeKind.Local).AddTicks(8197),
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 640, DateTimeKind.Local).AddTicks(8230)
                        });
                });
            ...
            modelBuilder.Entity("ProfitAndLoss.Data.Models.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2fd3c5c9-8947-4bc3-8ee4-972175def3e0"),
                            Actived = true,
                            BrandId = new Guid("05fe5bba-65ad-4b71-a5dd-08d878376f22"),
                            Code = "HCM-01",
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 641, DateTimeKind.Local).AddTicks(9051),
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 641, DateTimeKind.Local).AddTicks(9993),
            ...
            modelBuilder.Entity("ProfitAndLoss.Data.Models.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actived = true,
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 636, DateTimeKind.Local).AddTicks(4177),
                            IsDebit = true,
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(7526),
                            Name = "Sales"
                        },
                        new
                        {
                            ...
                            Actived = true,
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8626),
                            IsDebit = true,
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8722),
                            Name = "Revenues"
                        },
                        new
                        {
                            ...
                            Actived = true,
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8742),
                            IsDebit = true,
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8744),
                            Name = "Expenses"
                        },
                        new
                        {
                            ...
                            Actived = true,
                            CreatedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8748),
                            IsDebit = true,
                            ModifiedDate = new DateTime(2020, 10, 26, 11, 2, 9, 637, DateTimeKind.Local).AddTicks(8750),
                            Name = "Invoice"
                        });
                });
